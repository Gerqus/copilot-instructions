...
metadata: {
  "skill": "planner-old",
  "line": "codex",
  "counterpart": "/home/projekty/copilot-instructions/agents/Planner.old.md",
  "type": "agent-counterpart"
}
---

# Planner.old (Codex Counterpart)

This skill is the Codex-native equivalent of `/home/projekty/copilot-instructions/agents/Planner.old.md`.
...
- Use `request_user_input (Plan mode) or direct user questions` with concise, grounded options so the user approves direction instead of doing discovery on your behalf.
