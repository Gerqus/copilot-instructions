...
metadata: {
  "skill": "janitor",
  "line": "codex",
  "counterpart": "/home/projekty/copilot-instructions/agents/Janitor.agent.md",
  "type": "agent-counterpart"
}
---

# Janitor (Codex Counterpart)

This skill is the Codex-native equivalent of `/home/projekty/copilot-instructions/agents/Janitor.agent.md`.
...
- Use `request_user_input (Plan mode) or direct user questions` for scope confirmation, risk acceptance, ambiguous deletions, and to present cleanup bundles or priorities for the user to weigh in on.
