...
metadata: {
  ...
  "line": "codex",
  "counterpart": "/home/projekty/copilot-instructions/agents/Production incident triage.agent.md",
  "type": "agent-counterpart"
}
---

# Production incident triage (Codex Counterpart)

This skill is the Codex-native equivalent of `/home/projekty/copilot-instructions/agents/Production incident triage.agent.md`.
...
- Use `request_user_input (Plan mode) or direct user questions` for missing incident facts, mitigation approvals, prioritization, and to confirm your interpretation of symptoms and user reports.
