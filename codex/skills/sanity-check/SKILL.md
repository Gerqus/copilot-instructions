---
name: sanity-check
description: 'Perform a sanity check (Why-WhatFor analysis) on your work before finalizing an approach or code change.'
...
metadata: {
  ...
  "output": "A Why-WhatFor analysis result, validating or refuting the change."
}
---
