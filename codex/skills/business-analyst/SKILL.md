...
metadata: {
  ...
  "line": "codex",
  "counterpart": "/home/projekty/copilot-instructions/agents/Business Analyst.agent.md",
  "type": "agent-counterpart"
}
---

# Business Analyst (Codex Counterpart)

This skill is the Codex-native equivalent of `/home/projekty/copilot-instructions/agents/Business Analyst.agent.md`.
...
- Verifier and Programmer read `.agents/session/dod-<conversationId>.md` as the acceptance-criteria baseline.
...
3. Persist only the approved version to `.agents/session/dod-<conversationId>.md` using memory.
