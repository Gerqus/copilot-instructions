---
name: one-question-deep-analysis
...
user-invocable: true
metadata: {
  "skill": "one-question-deep-analysis",
  "line": "codex",
  "counterpart": "/home/projekty/copilot-instructions/agents/One-question deep analysis.agent.md",
  "type": "agent-counterpart"
}
---

# One-question deep analysis (Codex Counterpart)

This skill is the Codex-native equivalent of `/home/projekty/copilot-instructions/agents/One-question deep analysis.agent.md`.
...
- Use `request_user_input (Plan mode) or direct user questions` for scope clarification, intent checks, business trade-offs, and to validate key assumptions before building conclusions on them.
