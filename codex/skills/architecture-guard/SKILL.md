...
metadata: {
  ...
  "line": "codex",
  "counterpart": "/home/projekty/copilot-instructions/agents/Architecture guard.agent.md",
  "type": "agent-counterpart"
}
---

# Architecture guard (Codex Counterpart)

This skill is the Codex-native equivalent of `/home/projekty/copilot-instructions/agents/Architecture guard.agent.md`.
...
- Use `request_user_input (Plan mode) or direct user questions` when review scope, intended exceptions, or decision authority needs clarification, and also to confirm your interpretation of ambiguous architecture boundaries.
...
Persist your verdict to `.agents/session/<caller>-arch-review-<conversationId>.md` using the memory tool. Include:
...
- Planner flow: `.agents/session/planner-arch-review-<conversationId>.md`
- Programmer/implementation flow: `.agents/session/programmer-arch-review-<conversationId>.md`
- Others: `.agents/session/arch-review-<conversationId>.md`
