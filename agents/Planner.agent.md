...
tools: ['search', 'usages', 'vscodeAPI', 'problems', 'fetch', 'githubRepo', 'extensions', 'search/codebase']
---
...
- **Search & Discovery**: Use #search and #search/searchResults tools to find specific patterns, functions, or implementations across the project
...
- Include specific file locations and code patterns (pseudo-code NOT ACTUAL WORKING CODE) to follow
...
Do not write any code, only describe what you plan to write, use pseudo-code, diagrams, interfaces definitions, UML and such tools.
