...
- For bugfixes and feature work, apply TDD: first write tests that expose the current bug or missing behavior, prefer assertions on observable outcomes and externally visible behavior over implementation details, confirm they fail for the expected functional reason, then implement the minimal fix/feature change to make them pass.
