...
- [ ] Do critical TDD tests assert observable behavior/public contracts rather than internal implementation details?
- [ ] Are implementation-coupled tests (private method checks, strict internal call count/order assertions, mock-choreography checks) rejected as sufficient evidence unless they are only supplementary checks or explicit-contract checks?
