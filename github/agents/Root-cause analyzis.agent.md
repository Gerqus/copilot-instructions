...
- Use `vscode/askQuestions` to clarify issue reproduction steps, gather missing symptoms, resolve inconsistencies, or seek general clarifications about expected behavior and intermediate findings.
